...
def draw_gui(window,white,black,font):
    # clear screen    
    window.fill((white))    
    # draw rectangles
    Hdg = pygame.draw.rect(window, (black), (75, 75, 100, 50), 2)
    Thr = pygame.draw.rect(window, (black), (75, 175, 100, 50), 2)
    Alt = pygame.draw.rect(window, (black), (75, 275, 100, 50), 2)
    Roll = pygame.draw.rect(window, (black), (225, 75, 100, 50), 2)
    Pitch = pygame.draw.rect(window, (black), (225, 175, 100, 50), 2)
    Yaw = pygame.draw.rect(window, (black), (225, 275, 100, 50), 2)
    Batt = pygame.draw.rect(window, (black), (375, 75, 100, 50), 2)
    Vcc = pygame.draw.rect(window, (black), (375, 175, 100, 50), 2)
    Climb = pygame.draw.rect(window, (black), (375, 275, 100, 50), 2)
    # draw titles
    window.blit(font.render('Hdg', True, (black)), (75, 48))
    window.blit(font.render('Thr', True, (black)), (75, 148))
    window.blit(font.render('Alt', True, (black)), (75, 248))
    window.blit(font.render('Roll', True, (black)), (225, 48))
    window.blit(font.render('Pitch', True, (black)), (225, 148))
    window.blit(font.render('Yaw', True, (black)), (225, 248))
    window.blit(font.render('Batt %', True, (black)), (375, 48))
    window.blit(font.render('Vcc', True, (black)), (375, 148))
    window.blit(font.render('Climb', True, (black)), (375, 248))   

def gui(window):
    white = (255,255,255)    
    black=(0,0,0)
    font = pygame.font.SysFont('Arial', 25)
    draw_gui(window,white,black,font)
    pygame.display.flip()
    while True:
        while not('SCALED_IMU2' in mpstate.status.msgs and 'ATTITUDE' in mpstate.status.msgs and 'VFR_HUD' in mpstate.status.msgs\
            and 'SYS_STATUS' in mpstate.status.msgs and 'HWSTATUS' in mpstate.status.msgs):
            time.sleep(0.5)
        draw_gui(window,white,black,font)
        window.blit(font.render(str(mpstate.status.msgs['VFR_HUD'].heading), True, (black)), (90, 85))
        window.blit(font.render(str(mpstate.status.msgs['VFR_HUD'].throttle), True, (black)), (90, 185))
        window.blit(font.render(str(round(mpstate.status.msgs['VFR_HUD'].alt,2)), True, (black)), (90, 285))
        window.blit(font.render(str(round(57.3*mpstate.status.msgs['ATTITUDE'].roll,2)), True, (black)), (235, 85))
        window.blit(font.render(str(round(57.3*mpstate.status.msgs['ATTITUDE'].pitch,2)), True, (black)), (235, 185))
        window.blit(font.render(str(round(57.3*mpstate.status.msgs['ATTITUDE'].yaw,2)), True, (black)), (235, 285))
        window.blit(font.render(str(round(mpstate.status.msgs['SYS_STATUS'].battery_remaining,2)), True, (black)), (385, 85))
        window.blit(font.render(str(round(mpstate.status.msgs['HWSTATUS'].Vcc,2)), True, (black)), (385, 185))
        window.blit(font.render(str(round(mpstate.status.msgs['VFR_HUD'].climb,2)), True, (black)), (385, 285))    
        pygame.display.flip()
...
def quad_control():
    ...
    GUI_thread = threading.Thread(target=gui,args=(window,))
        ...
        for event in pygame.event.get():
            if (event.type == pygame.KEYDOWN ):
                ...
                if(event.key == pygame.K_KP_ENTER):
                    process_stdin('rc 3 1040')
                    time.sleep(2)                    
                    process_stdin('rc 3 1200')
                    time.sleep(2)
                    process_stdin('rc 3 1040')
                    time.sleep(2)
                    process_stdin('rc 3 1000')
